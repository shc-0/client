...
export default function Home() {
  return (
    <>
      ...
      <main>
        {/* 1 */}
        <div className="position-relative overflow-hidden mains firstDiv">
          <div className="col-md-6 p-xl-5 mx-auto my-5 siteName">
            <h1 className="display-4 fw-normal">Epidemica</h1>
            <p style={{ opacity: 1 }}>
        ...
        <div className="row">
          ...
          <div className="col-6 col-md">
            ...
            <ul className="list-unstyled text-div">
              <li>
                <a className="link-secondary" href="https://github.com/shc-0/Epidemica">
          ...
          <div className="col-6 col-md">
            ...
            <ul className="list-unstyled text-div">
              <li>
                <a className="link-secondary" href="www.linkedin.com/in/shashwat-c">
                  <i className="fab fa-linkedin"></i> shashwat-c
                </a>
              </li>
              <li>
                <a className="link-secondary" href="https://www.instagram.com/shashwat_chouhan/">
                  <i className="fab fa-instagram"></i> shashwat_chouhan
                </a>
              </li>
              <li>
                <a className="link-secondary" href="https://github.com/shc-0">
                  <i className="fab fa-github"></i> shc-0
                </a>
              </li>
            </ul>
          </div>
